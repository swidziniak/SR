...
class DatasetSplitter:
    ...
    def __init__(self, exclude_profiles: Vector = None, columns: Vector = None):
        ...
        if columns:
            ...
            self.data_format = DatasetSplitter.DEFAULT_COLUMNS
    ...
    def timestamps_to_sorted_dates(self):
        # Konsulatowalem sie z panem Rieglem,
        # Kod jest moj, ale kolega zaproponowal sortowac tylko po dniu, zeby przyspieszyc proces
        # Stad kolumna tymczasowa days_since_year_begin
